...
<!--
          <li>
            <a href="javascript:alert('Download SWAL2');"><i class="fa fa-sign-out"></i></a>
          </li>
-->
        </ul>
      </div>
...
-->
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
        ...
        Based on <a href="https://almsaeedstudio.com/">AdminLTE Template</a>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#"><?php echo CHtml::encode(Yii::app()->name); ?></a>.</strong> All rights reserved.
  </footer>
